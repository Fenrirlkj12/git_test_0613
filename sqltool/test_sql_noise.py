...
def execute_query(code:str, sqlmode:str):
    ...
    username = 'sa'
    password = '1a2b3c4D'
    conn = pymssql.connect(host=server, database=database, user=username, password=password, charset='utf8')
    cursor = conn.cursor()
...
def noise_data_sql(sqlmode: Literal['声压级', '音频', '定位'], stations_code:list, stations_name:list, *args):
    res = {}
...
if __name__ == '__main__':
    station = {
        'name': ['赛纳科技中心', '佛山生态环境监测站', '德胜广场', 'T21创意产业园', '新宁公园', '中新科技文化艺术中心', '测试站点1'],
        'code': ['0756168807', '075616880901', '0756168810', '075616881002', '075616881003', '0756168811', 'station1']
    }
    sqlmode = '声压级'
